...
class TtnAccess():
    # This class is a wrapper for some TTN operations. It utilizes a "full account" key to authenticate
    # Its capabilities are
    # - creation of new TTN apps (with id, name and description)
    # - creation of new TTN enddevices (with JoinEUI, DevEUI, DevID, AppID and AppKey)
    #   - frequency: EU_863_870_TTN
    #   - lorawan version: MAC_V1_0_2
    #   Change these specifications to whatever you need
    # - creation of an uplink (JavaScript) payload formatter of an enddevice in TTN
    # - deletion of an enddevice of a TTN app
    # - deletion of a TTN app
    # - retrieval of the DevEUIs generated by TTN
    # - generation of random DevEUIs
    # - creation of OpenSenseMap webhooks in a TTN app
